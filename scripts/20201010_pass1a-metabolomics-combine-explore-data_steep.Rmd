 ...
 * Create Count (Abundance) Data Table
 * Incorporate Phenotypic Data
...
### Create Metabolomics Metadata and Count (Abundance) Data Tables
```{r Create Metabolomics Metadata Table, warning = FALSE}
# Loop creates a metadata table from the directory tree of metabolomics data realese 2.0
########################################
if(F){
# Variables
#####################
...
# Remove the original Mayo clinic samples and replace with replicates
countdata_df <- countdata_df %>%
  filter(STUDY_INSTITUTE != 'Mayo Clinic')
